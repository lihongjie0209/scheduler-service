...
RUN CGO_ENABLED=0 go build -trimpath -ldflags="-s -w -X github.com/lihongjie0209/scheduler-service/internal/buildinfo.Version=${VERSION} -X github.com/lihongjie0209/scheduler-service/internal/buildinfo.Commit=${COMMIT} -X github.com/lihongjie0209/scheduler-service/internal/buildinfo.BuildTime=${BUILD_TIME}" -o /out/api ./cmd/api
...
LABEL org.opencontainers.image.title="scheduler-service" \
      ...
      org.opencontainers.image.source="https://github.com/lihongjie0209/scheduler-service"
WORKDIR /app
