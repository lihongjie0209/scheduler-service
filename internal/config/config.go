...
func setDefaults(v *viper.Viper) {
	v.SetDefault("app.name", "scheduler-service")
	...
	v.SetDefault("database.schema", "scheduler")
	...
	v.SetDefault("jwt.issuer", "scheduler-service")
	...
	v.SetDefault("auth.audience", "scheduler-service")
	...
	v.SetDefault("migration.table", "scheduler_schema_migrations")
