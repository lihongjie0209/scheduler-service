...
import (
	...
	"github.com/lihongjie0209/scheduler-service/internal/environment"
	apphealth "github.com/lihongjie0209/scheduler-service/internal/health"
...
func NewServer(lc fx.Lifecycle, cfg config.Config, authService *auth.Service, authorizer platformauthz.Authorizer, healthService *apphealth.Service, jobs *job.Service, idempotencyManager *idempotency.Manager, metrics *observability.Metrics, logger *slog.Logger) (*Server, error) {
	...
	schedulerv1.RegisterSchedulerServiceServer(grpcServer, newSchedulerServer(jobs))
